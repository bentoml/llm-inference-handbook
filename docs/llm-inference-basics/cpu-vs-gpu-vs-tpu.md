...
- **On-Prem**: [On-premises deployments](../getting-started/on-prem-llms) means running LLM inference on your own infrastructure, typically within a private data center. It offers full control over data, performance, and compliance, but requires more operational overhead.
