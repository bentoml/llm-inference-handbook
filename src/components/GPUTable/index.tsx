...
const GPU_DATA: GPU[] = [
  ...
  },
  {
    ...
    exampleLLMs: ['Llama-3-8B', 'Gemma-3-4B', 'Qwen3.5-9B'],
  ...
  },
  {
    ...
    exampleLLMs: ['Gemma-3-12B/27B', 'gpt-oss-20b', 'Llama-3.3-70B'],
  ...
  },
  {
    ...
    exampleLLMs: ['Llama-4-Maverick', 'gpt-oss-120b', 'GLM-4.7', 'MiMo-V2-Flash'],
  ...
  },
  {
    ...
    exampleLLMs: ['DeepSeek-R1-0528', 'DeepSeek-V3.2', 'Kimi-K2.5', 'Qwen3.5-397B-A17B', 'GLM-5'],
  ...
  },
  {
    ...
    exampleLLMs: ['gpt-oss-120b', 'MiniMax-M2.5', 'DeepSeek-R1-0528', 'Qwen3.5-397B-A17B'],
  ...
  },
  {
    ...
    exampleLLMs: ['MiniMax-M2.5', 'DeepSeek-V3.2', 'Qwen3.5-397B-A17B'],
