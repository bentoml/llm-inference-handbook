...
.mh-mobile-toggle[aria-expanded='true'] .mh-mobile-toggle-lines span:nth-child(1) {
  transform: translateY(5px) rotate(45deg);
}

.mh-mobile-toggle[aria-expanded='true'] .mh-mobile-toggle-lines span:nth-child(2) {
  opacity: 0;
}

.mh-mobile-toggle[aria-expanded='true'] .mh-mobile-toggle-lines span:nth-child(3) {
  transform: translateY(-5px) rotate(-45deg);
}
